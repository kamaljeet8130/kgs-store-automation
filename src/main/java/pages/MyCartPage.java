...
public class MyCartPage {
    ...
    private By emptyCartImage = By.xpath("//img[@alt='No Product in Cart']");
    private By emptyCartMessage = By.xpath("//h1[text()='Cart Empty']");
    ...
    private By backToStoreButton = By.xpath("//button[contains(text(),'Back to Store')]");
